...
public class AcademicLeavePdf {
    public static void generate(UserDto user) {
        try {
            PdfDocument pdf = new PdfDocument(new PdfWriter("academic_leave.pdf"));
            ...
            Paragraph p6 = new Paragraph("Я, " + user.getFirst_name() + " " + user.getLast_name() + ", " + user.getNumberOfpassport() + ", " + user.getAge() + ", " + "прошу Вас выдать академический отпуск по болезни.");
