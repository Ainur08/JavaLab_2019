...
import ru.multiclientchat.model.*;
import ru.multiclientchat.net.Session;
import ru.multiclientchat.service.AdminService;
import ru.multiclientchat.service.UserService;
...
public class MenuController {
    ...
    public void openChat() {
        ...
        while (true) {
            ...
            //TODO with userID
            Message message = new Message(1, new SimpleDateFormat("HH:mm:ss").format(new Date()), messageText);
    ...
    public void openArchive() {
        ...
        Archive archive = new Archive("get messages", page, size);
